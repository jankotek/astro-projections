 ...
 * pixels for any pixel that belongs to one of the other groups.  E.g.,
 ...
 * components include the 'shadow' pixels needed to draw the pixel appropriately
 ...
 * no more than that. 
 * 
 * Ait straddling does not currently truncate clip the straddle components,
